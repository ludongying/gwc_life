...
public class ShiroConfig {
    ...
    public DefaultWebSessionManager defaultWebSessionManager(CacheManager cacheShiroManager, TonFunProperties tonFunProperties) {
        ...
        sessionManager.setGlobalSessionTimeout(tonFunProperties.getSessionInvalidateTime() * 1000);
    ...
    public ShiroFilterFactoryBean shiroFilter(DefaultWebSecurityManager securityManager) {
        ...
        myFilters.put("user", new TonFunUserFilter());
        ...
        for (String nonePermissionRe : ConfigConsts.NONE_PERMISSION_RES) {
