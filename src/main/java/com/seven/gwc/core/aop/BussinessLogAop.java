...
import com.seven.gwc.core.log.factory.LogTaskFactory;
import com.seven.gwc.core.shiro.ShiroKit;
import com.seven.gwc.core.shiro.ShiroUser;
import com.seven.gwc.core.util.ContrastUtil;
...
public class BussinessLogAop {
    ...
    @Pointcut(value = "@annotation(com.seven.gwc.core.annotation.BussinessLog)")
    ...
    private void handle(ProceedingJoinPoint point) throws Exception {
        ...
        if (bussinessName.contains("修改") || bussinessName.contains("编辑")) {
            ...
            Map<String, String> obj2 = HttpContextUtil.getRequestParameters();
