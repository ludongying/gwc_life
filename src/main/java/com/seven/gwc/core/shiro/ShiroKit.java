...
public class ShiroKit {
    ...
    public static ShiroUser getUserNotNull() {
        if (isGuest()) {
            throw new BusinessException(ErrorEnum.ERROR_USER_UNLOGIN);
        } else {
            return (ShiroUser) getSubject().getPrincipals().getPrimaryPrincipal();
        }
    }
...
//        List<Long> subDeptIds = CacheFactory.me().getSubDeptId(deptId);
...
//    }
     ...
     */
    public static ShiroUser createShiroUser(UserEntity userEntity) {
        ...
        shiroUser.setId(userEntity.getId());
        shiroUser.setAccount(userEntity.getAccount());
        shiroUser.setDeptId(userEntity.getDeptId());
        shiroUser.setDeptName(CacheFactory.me().getDeptName(userEntity.getDeptId()));
