...
INSTRUMENT_03(3,"02目录.docx", 2,Arrays.asList(1,2),Arrays.asList(12),Arrays.asList(1)),
INSTRUMENT_04(4,"03行政处罚决定书_法人.docx", 2,Arrays.asList(1,2),Arrays.asList(1),Arrays.asList(1,2,20)),
INSTRUMENT_05(5,"03行政处罚决定书_法人_安.docx", 2,Arrays.asList(2),Arrays.asList(1),Arrays.asList(1,4,21)),
INSTRUMENT_06(6,"03行政处罚决定书_自然人.docx", 2,Arrays.asList(1),Arrays.asList(2),Arrays.asList(1,2,20)),
INSTRUMENT_07(7,"03行政处罚决定书_自然人_安.docx", 2,Arrays.asList(2),Arrays.asList(2),Arrays.asList(1,4,21)),
INSTRUMENT_08(8,"04案件移送函.docx", 3,Arrays.asList(1,2),Arrays.asList(1,2),Arrays.asList(100)),
INSTRUMENT_09(9,"05行政处罚立案审批表_法人.docx", 2,Arrays.asList(1),Arrays.asList(1),Arrays.asList(1,5,20)),
INSTRUMENT_10(10,"05行政处罚立案审批表_法人_安.docx", 2,Arrays.asList(2),Arrays.asList(1),Arrays.asList(1,5,21)),
INSTRUMENT_11(11,"05行政处罚立案审批表_自然人.docx", 2,Arrays.asList(1),Arrays.asList(2),Arrays.asList(1,5,20)),
INSTRUMENT_12(12,"05行政处罚立案审批表_自然人_安.docx", 2,Arrays.asList(2),Arrays.asList(2),Arrays.asList(1,4,5,21)),
INSTRUMENT_13(13,"06勘验笔录.docx", 2,Arrays.asList(1),Arrays.asList(1,2),Arrays.asList(1,2,3)),
INSTRUMENT_14(14,"06勘验笔录_安.docx", 2,Arrays.asList(2),Arrays.asList(1,2),Arrays.asList(1,4,21)),
INSTRUMENT_INQUIRE(15,"07询问笔录.docx", 2,Arrays.asList(1),Arrays.asList(1,2),Arrays.asList(1,2,3)),
INSTRUMENT_16(16,"07询问笔录_安.docx", 2,Arrays.asList(2),Arrays.asList(1,2),Arrays.asList(1,3,4)),
INSTRUMENT_17(17,"08相关证书复印件.docx", 3,Arrays.asList(100),Arrays.asList(100),Arrays.asList(100)),
...
INSTRUMENT_22(22,"13案件处理意见书_法人.docx", 2,Arrays.asList(1),Arrays.asList(1),Arrays.asList(1,2,5,20)),
INSTRUMENT_23(23,"13案件处理意见书_法人_安.docx", 2,Arrays.asList(2),Arrays.asList(1),Arrays.asList(1,4,5,21)),
INSTRUMENT_24(24,"13案件处理意见书_自然人.docx", 2,Arrays.asList(1),Arrays.asList(2),Arrays.asList(1,2,5,20)),
INSTRUMENT_25(25,"13案件处理意见书_自然人_安.docx", 2,Arrays.asList(2),Arrays.asList(2),Arrays.asList(1,4,21)),
...
INSTRUMENT_30(30,"15陈述和申辩笔录.docx", 2,Arrays.asList(1,2),Arrays.asList(1,2),Arrays.asList(1,2,4,5)),
...
INSTRUMENT_36(36,"21送达回证二.docx", 2,Arrays.asList(1,2),Arrays.asList(1,2),Arrays.asList(1,5,20,21)),
INSTRUMENT_37(37,"21送达回证一.docx", 2,Arrays.asList(1,2),Arrays.asList(1,2),Arrays.asList(1,5,20,21)),
...
INSTRUMENT_40(40,"24行政处罚结案报告_法人.docx", 2,Arrays.asList(1,2),Arrays.asList(1),Arrays.asList(1,5,20,21)),
INSTRUMENT_41(41,"24行政处罚结案报告_自然人.docx", 2,Arrays.asList(1,2),Arrays.asList(2),Arrays.asList(1,5,20,21)),
INSTRUMENT_42(42,"25备考表.docx", 2,Arrays.asList(1,2),Arrays.asList(1,2),Arrays.asList(1)),
INSTRUMENT_43(43,"26行政处罚决定审批表_法人.docx", 1,Arrays.asList(1,2),Arrays.asList(1),Arrays.asList(1,5,20,21)),
INSTRUMENT_44(44,"26行政处罚决定审批表_自然人.docx", 2,Arrays.asList(1,2),Arrays.asList(2),Arrays.asList(5,20,21)),
...
INSTRUMENT_48(48,"27责令返港通知书_自然人_安.docx", 1,Arrays.asList(2),Arrays.asList(1),Arrays.asList(1,5,21)),
...
INSTRUMENT_52(52,"29责令整改通知书_自然人.docx", 1,Arrays.asList(2),Arrays.asList(2),Arrays.asList(1,20)),
...
INSTRUMENT_55(55,"30整改承诺书_安.docx", 2,Arrays.asList(2),Arrays.asList(1,2),Arrays.asList(1,5)),
