...
INSTRUMENT_01(1,"01封面_法人.docx",               1,Arrays.asList(1,2),Arrays.asList(1),Arrays.asList(1,2,5,20,21)),
INSTRUMENT_02(2,"01封面_自然人.docx",             1,Arrays.asList(1,2),Arrays.asList(2),Arrays.asList(1,2,5,20,21)),
...
INSTRUMENT_10(10,"05行政处罚立案审批表_法人_安.docx", 1,Arrays.asList(2),Arrays.asList(1),Arrays.asList(1,4,5,21)),
...
INSTRUMENT_13(13,"06勘验笔录.docx", 1,Arrays.asList(1),Arrays.asList(1,2),Arrays.asList(1,2,3,20)),
INSTRUMENT_14(14,"06勘验笔录_安.docx", 1,Arrays.asList(2),Arrays.asList(1,2),Arrays.asList(1,4,21)),
INSTRUMENT_INQUIRE(15,"07询问笔录.docx", 1,Arrays.asList(1),Arrays.asList(1,2),Arrays.asList(1,2,3,20)),
INSTRUMENT_16(16,"07询问笔录_安.docx", 1,Arrays.asList(2),Arrays.asList(1,2),Arrays.asList(1,4,21)),
...
INSTRUMENT_19(19,"10证据登记保存清单.docx", 2,Arrays.asList(1,2),Arrays.asList(1,2),Arrays.asList(100)),
INSTRUMENT_20(20,"11登记保存物品处理通知书.docx", 2,Arrays.asList(1,2),Arrays.asList(1,2),Arrays.asList(100)),
INSTRUMENT_21(21,"12查封（扣押）决定书和清单.docx", 2,Arrays.asList(1,2),Arrays.asList(1,2),Arrays.asList(1,5,20,21)),
INSTRUMENT_22(22,"13案件处理意见书_法人.docx", 1,Arrays.asList(1),Arrays.asList(1),Arrays.asList(1,5,20)),
INSTRUMENT_23(23,"13案件处理意见书_法人_安.docx", 1,Arrays.asList(2),Arrays.asList(1),Arrays.asList(1,4,5,20,21)),
INSTRUMENT_24(24,"13案件处理意见书_自然人.docx", 1,Arrays.asList(1),Arrays.asList(2),Arrays.asList(1,5,20)),
INSTRUMENT_25(25,"13案件处理意见书_自然人_安.docx", 1,Arrays.asList(2),Arrays.asList(2),Arrays.asList(1,4,5,20,21)),
INSTRUMENT_26(26,"14行政处罚事先告知书_法人.docx", 1,Arrays.asList(1),Arrays.asList(1),Arrays.asList(1,2,3,20)),
INSTRUMENT_27(27,"14行政处罚事先告知书_法人_安.docx", 1,Arrays.asList(2),Arrays.asList(1),Arrays.asList(1,4,5,21)),
INSTRUMENT_28(28,"14行政处罚事先告知书_自然人.docx", 1,Arrays.asList(1),Arrays.asList(2),Arrays.asList(1,2,3,20)),
INSTRUMENT_29(29,"14行政处罚事先告知书_自然人_安.docx", 1,Arrays.asList(2),Arrays.asList(2),Arrays.asList(1,4,5,20,21)),
INSTRUMENT_30(30,"15陈述和申辩笔录.docx", 1,Arrays.asList(1,2),Arrays.asList(1,2),Arrays.asList(1,4,5)),
INSTRUMENT_31(31,"16行政处罚听证会通知书.docx", 2,Arrays.asList(1,2),Arrays.asList(1,2),Arrays.asList(1,20,21)),
INSTRUMENT_32(32,"17听证笔录.docx", 3,Arrays.asList(1,2),Arrays.asList(1,2),Arrays.asList(100)),
INSTRUMENT_33(33,"18行政处罚听证会报告书.docx", 3,Arrays.asList(1,2),Arrays.asList(1,2),Arrays.asList(1)),
INSTRUMENT_34(34,"19解除查封（扣押）通知书.docx", 2,Arrays.asList(1,2),Arrays.asList(1,2),Arrays.asList(100)),
...
INSTRUMENT_38(38,"22要求当场缴纳罚款的申请书.docx", 2,Arrays.asList(1,2),Arrays.asList(1,2),Arrays.asList(20,21)),
...
//INSTRUMENT_57(57,"32渔船安全检查记录表.docx", 2,Arrays.asList(1,2),Arrays.asList(1,2),Arrays.asList(2,4,20,21));
    ...
    public static String getPath(){
        return FileUtils.getStaticPath()+FileUtils.file_sep+"lawrecord"+FileUtils.file_sep+"instrument"+FileUtils.file_sep;
    }
