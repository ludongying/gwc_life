 ...
 */
@Controller
@RequestMapping("filmManage")
public class FilmManageController extends BaseController {

    private Logger log = LoggerFactory.getLogger(this.getClass());

    private static String PREFIX = "/modular/manage_film/";
    ...
    @RequestMapping("")
    public String index() {
        return PREFIX + "film_manage";
    }

    /**
     * 跳转到添加信息
     */
    @RequestMapping("/filmManage_add")
    public String personAdd() {
        return PREFIX + "film_manage_add";
    }
