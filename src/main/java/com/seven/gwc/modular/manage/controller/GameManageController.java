...
public class GameManageController extends BaseController {
    ...
    private static String PREFIX = "/modular/manage_game/";
    ...
    @RequestMapping("")
    public String index() {
        return PREFIX + "game_manage";
    }

    /**
     * 跳转到添加信息
     */
    @RequestMapping("/gameManage_add")
    public String personAdd() {
        return PREFIX + "game_manage_add";
    }

    /**
     * 跳转到剧集管理信息
     * */
   @RequestMapping("/gameManage_series")
    public String gameSeries(String id) {
        return PREFIX + "game_series";
  }
//
//    /**
//     * 跳转到修改船员信息
