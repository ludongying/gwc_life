 ...
 */
@Controller
@RequestMapping("tvManage")
public class TvManageController extends BaseController {

    private Logger log = LoggerFactory.getLogger(this.getClass());

    private static String PREFIX = "/modular/manage_tv/";
    ...
    @RequestMapping("")
    public String index() {
        return PREFIX + "tv_manage";
    }

    /**
     * 跳转到添加信息
     */
    @RequestMapping("/tvManage_add")
    public String personAdd() {
        return PREFIX + "tv_manage_add";
    }

    /**
     * 跳转到剧集管理信息
     * */
   @RequestMapping("/tvManage_series")
    public String tvSeries(String id) {
        return PREFIX + "tv_series";
  }
//
//    /**
//     * 跳转到修改船员信息
