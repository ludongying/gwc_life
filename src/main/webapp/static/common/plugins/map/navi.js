layui.define(['jquery', 'layer', 'admin', 'table'], function (exports) {
    ...
    var navi = {
        ...
        fabs: function(x) { return Math.abs(x); },
        sqrt: function(x) { return Math.sqrt(x); },
        log: function(x) { return Math.log(x); },
        pow: function(x, y) { return Math.pow(x, y); },
        ceil: function(x) { return Math.ceil(x); },
        fmin: function(x, y) { return Math.min(x, y); },
        fmax: function(x, y) { return Math.max(x, y); },
        st_norm2: function(x, y) {
        var a;
        var b;
        a = fabs(x);
        b = fabs(y);
        ...
        w84ge_ll2sa: function(lat1, lon1, lat2, lon2) {
        var up;
        var b_lat1;
        var cgam1;
        var lon12;
        ...
        w84ge_sa2ll: function(lat1, lon1, s, azi1) {
