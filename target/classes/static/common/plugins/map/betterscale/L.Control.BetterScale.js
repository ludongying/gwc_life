L.Control.BetterScale = L.Control.extend({
    ...
    _updateImperial: function (t) {
        var e, i, n, o, s, a = 3.2808399 * t,
            ...
            l = this._iScale,
            u = this._iScaleLabel;
        u.innerHTML = "", a > 2640 ? (e = a / 5280, i = this._getRoundNum(e), o = this._getRoundNum(e / 2), l.style.width = this._getScaleWidth(i / e) + "px", r.innerHTML = o, h.innerHTML = i + "m") : (n = this._getRoundNum(a), s = this._getRoundNum(a / 2), l.style.width = this._getScaleWidth(n / a) + "px", r.innerHTML = s, h.innerHTML = n + "ft")
    },
